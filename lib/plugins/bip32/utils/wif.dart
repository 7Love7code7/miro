...
Uint8List encodeRaw(int version, Uint8List privateKey, {required bool compressed}) {
...
String encode(WIF wif) {
  return bs58check.encode(encodeRaw(wif.version, wif.privateKey, compressed: wif.compressed));
}
